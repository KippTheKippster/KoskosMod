...
package net.mcreator.koskosmod.client.gui;
...
public class HampterTradeGUIScreen extends AbstractContainerScreen<HampterTradeGUIMenu> {
	private final static HashMap<String, Object> guistate = HampterTradeGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public HampterTradeGUIScreen(HampterTradeGUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Trade with the Hampter!", 24, 16, -12829636);
	}
