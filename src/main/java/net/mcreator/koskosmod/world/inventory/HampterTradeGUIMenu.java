...
package net.mcreator.koskosmod.world.inventory;
...
public class HampterTradeGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public HampterTradeGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(KoskosModModMenus.HAMPTER_TRADE_GUI.get(), id);
