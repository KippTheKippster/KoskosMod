 ...
 *
 */
package net.mcreator.koskosmod;
...
import net.mcreator.koskosmod.init.KoskosModModBiomes;
...
@Mod("koskos_mod")
public class KoskosModMod {
	public static final Logger LOGGER = LogManager.getLogger(KoskosModMod.class);
	public static final String MODID = "koskos_mod";
	...
	public KoskosModMod() {
		...
		KoskosModModEntities.REGISTRY.register(bus);

		KoskosModModMenus.REGISTRY.register(bus);
		KoskosModModBiomes.REGISTRY.register(bus);
	}
